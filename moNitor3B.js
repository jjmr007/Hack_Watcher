...
class SocketWatch {
  ...
  findTxApp() {
    ...
    var Mssge = "Finding emitted Approval events...";
    console.log(Mssge);
    ...
    this.subscription.on("data", (eVnt) => {
      console.log(eVnt);
      Mssge = "new APPROVAL event found to DOC contract at transaction: " + eVnt.transactionHash + "; at the block number: " + eVnt.blockNumber + ", with block hash number: " + eVnt.blockHash;
...
let E = "Approval(address,address,uint256)";
